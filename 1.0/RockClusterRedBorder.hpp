#ifndef UE4SS_SDK_RockClusterRedBorder_HPP
#define UE4SS_SDK_RockClusterRedBorder_HPP

class ARockClusterRedBorder_C : public AActor
{
    ...
    class UStaticMeshComponent* RockShorlineCliffRed4;
    class UStaticMeshComponent* RockShorlineCliffRed3;
    class UStaticMeshComponent* RockShorlineCliffRed2;
    class UStaticMeshComponent* RockShorlineCliffRed1;
    class UStaticMeshComponent* RockShorlineCliffRed;
