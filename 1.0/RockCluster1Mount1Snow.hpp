#ifndef UE4SS_SDK_RockCluster1Mount1Snow_HPP
#define UE4SS_SDK_RockCluster1Mount1Snow_HPP

class ARockCluster1Mount1Snow_C : public AActor
{
    ...
    class UStaticMeshComponent* RockShorlineCliffLayer3;
