#ifndef UE4SS_SDK_CoverFullStoneWall2acSnow_HPP
#define UE4SS_SDK_CoverFullStoneWall2acSnow_HPP

class ACoverFullStoneWall2acSnow_C : public AActor
{
    ...
    class UStaticMeshComponent* PillarStoneWall2;
    class UStaticMeshComponent* CoverFullStoneWall2;
