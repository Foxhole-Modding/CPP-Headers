#ifndef UE4SS_SDK_RockCluster1Mount2Snow_HPP
#define UE4SS_SDK_RockCluster1Mount2Snow_HPP

class ARockCluster1Mount2Snow_C : public AActor
{
    ...
    class UStaticMeshComponent* RockShorlineCliff1;
    ...
    class UStaticMeshComponent* RockShorlineLarge;
    class UStaticMeshComponent* RockShorlineCliff;
    ...
    class UDecalComponent* RockDecal;
    ...
    class UStaticMeshComponent* RockShorlineSmall;
    class UStaticMeshComponent* RockShorlineMeduimv2;
    class UStaticMeshComponent* RockShorlineMeduim;
    class UStaticMeshComponent* RockShorlineCliffLayer2;
