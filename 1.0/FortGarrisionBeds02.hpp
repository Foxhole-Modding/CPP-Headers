#ifndef UE4SS_SDK_FortGarrisionBeds02_HPP
#define UE4SS_SDK_FortGarrisionBeds02_HPP

class AFortGarrisionBeds02_C : public AModificationTemplate
{
    ...
    class UStaticMeshComponent* Locker01;
